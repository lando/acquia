...
Note that if Lando cannot find an [Acquia API key](https://docs.acquia.com/acquia-cloud-platform/cloud-platform-api-v2-authentication) associated with your local site, it will prompt you to enter one. You can also switch to a different key by using the  `--key` and `--secret` options.
...
Note again that if Lando cannot find an [Acquia API key](https://docs.acquia.com/acquia-cloud-platform/cloud-platform-api-v2-authentication) associated with your local site, it will prompt you to enter one. You can also switch to a different key by using the  `--key` and `--secret` options.
