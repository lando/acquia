...
module.exports = class AcquiaApi {
   ...
   * @returns {Promise<object>} A promise that resolves to the account object or the token object if tokenOnly is true.
   */
   ...
   * @returns {Promise<object | undefined>} A promise that resolves with the API response if a new key is posted,
