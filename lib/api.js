...
module.exports = class AcquiaApi {
   ...
   * @param {boolean} force Cache bustera
   * @param {boolean} tokenOnly return only token, not account which requires an extra call
   * @returns {Promise}
   */
   ...
   * @returns {Promise} Acquia applications array
   */
  getApplications() {
